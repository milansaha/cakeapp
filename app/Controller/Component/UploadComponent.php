...
class UploadComponent extends Component {
     ...
     *
     */
    public function upload($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL, $uniqueName= null) {
        $this->result = false;
        $this->error = false;
        //var_dump($file);die; 
        ...
        if (!is_null($allowed)) {
            ...
            $this->_allowed = array('JPG', 'jpg', 'JPEG', 'jpeg', 'gif', 'GIF', 'png', 'PNG','mp3');
        }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function moveFile($file, $source, $destination, $name = NULL, $rules = NULL, $allowed = NULL, $uniqueName= null) {
        $this->result = false;
        $this->error = false;
        ...
        if (!is_null($allowed)) {
            ...
            $this->_allowed = array('JPG', 'jpg', 'JPEG', 'jpeg', 'gif', 'GIF', 'png', 'PNG');
        }
        ...
        if (file_exists($source . $file)) {
            ...
            if (file_exists($destination . $file)) {
                $fileName = $this->createnewname($file);
            } else {
                $fileName = $file;
            }
            if ($file != '' && $fileName != '') {
                $successful = copy($source . $file, $destination . $fileName);
                if ($successful) {
                    unlink($source . $file);
                    return $fileName;
                }
                ...
                unlink($source . $file);
                $this->error("Possible file upload attack on '$file'");
            }
        } else {
            unlink($source . $file);
            $this->error("Possible file upload attack on '$file'");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function createnewname($file) {
        $findDotPosition = strrpos($file, ".");
        $partOfName = substr($file, 0, ($findDotPosition - 1));
        return $partOfName . "_" . time() . "." . $this->ext($file);
    }
